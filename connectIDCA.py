...
'''
File: connectIDCA.py
Description: Allows client to connect to SCEP ID CA
...
def connection():   
	...
	# Send GETCACERT request
        print('Sending GETACERT request to ID CA...\n')
	...
	thread.join()
        ...
        if caCert_hash == caHash:
            print('ID CA public certificate hash successfully verified\n')
        else:
            print('ID CA public certificate invalid\n')
