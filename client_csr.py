...
'''
File: client_csr.py
Description: Allows client to send CSR to DEVICE CA
...
def send_csr():   
    ...
    try:
        ...
        # Let CA know ready for device certificate
        print('Receiving Device Certificate from ORION DEVICE CA...\n')
        serverReply = fileConnection.recv(1024)
        ...
        deviceCert = CN + '.device.crt'
        # Receive the p12 containing the signed device public certificate
