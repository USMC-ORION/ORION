...
'''
File: connectCA.py
Description: Allows client to connect to SCEP DEVICE CA
...
def connection():   
	...
	# Send GETCACERT request
        print('Sending GETACERT request to DEVICE CA...\n')
	...
	thread.join()
        ...
        if caCert_hash == caHash:
            print('DEVICE CA public certificate hash successfully verified\n')
        else:
            print('DEVICE CA public certificate invalid\n')
